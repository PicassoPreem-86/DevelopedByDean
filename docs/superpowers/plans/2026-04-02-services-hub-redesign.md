# Services Hub Page Redesign — Implementation Plan

> **For agentic workers:** REQUIRED SUB-SKILL: Use superpowers:subagent-driven-development (recommended) or superpowers:executing-plans to implement this plan task-by-task. Steps use checkbox (`- [ ]`) syntax for tracking.

**Goal:** Rewrite `/services` (ServicesHubPage.tsx) from a minimal index into an 8-section, SEO-optimized pillar page that ranks, educates SMB visitors, and converts them into strategy calls.

**Architecture:** Single-file rewrite of `src/pages/ServicesHubPage.tsx`. All 8 sections live inline — they're page-specific, not reused. Reuses `FinalCTA` and `SEO` components. Pulls service/industry data from `seoPages.ts`. Adds FAQ structured data via `react-helmet-async`. CountUp animation logic is inlined (same pattern as StatsBar).

**Tech Stack:** React 19, TypeScript, Tailwind CSS, Framer Motion, Lucide icons, react-helmet-async

**Spec:** `docs/superpowers/specs/2026-04-02-services-hub-redesign.md`

---

### Task 1: Hero Section + SEO Meta

**Files:**
- Modify: `src/pages/ServicesHubPage.tsx`

- [ ] **Step 1: Replace the entire ServicesHubPage with the new hero section and updated SEO**

Replace the full contents of `src/pages/ServicesHubPage.tsx` with:
...
Run: `cd /Users/preem/Desktop/DevelopedByDean && npx tsc --noEmit`
Expected: No errors

- [ ] **Step 3: Verify dev server renders the page**

Run: `cd /Users/preem/Desktop/DevelopedByDean && pnpm dev`
Visit: `http://localhost:5173/services`
Expected: All 8 sections render — dark hero, pain strip, services grid, how it works, industry cards, stats, FAQ accordion, final CTA form.

- [ ] **Step 4: Verify build passes**

Run: `cd /Users/preem/Desktop/DevelopedByDean && pnpm build`
Expected: Build completes with no errors

- [ ] **Step 5: Run tests**

Run: `cd /Users/preem/Desktop/DevelopedByDean && pnpm test`
Expected: All tests pass (FoundingWall failures are known/ignored)

- [ ] **Step 6: Commit**

```bash
cd /Users/preem/Desktop/DevelopedByDean
git add src/pages/ServicesHubPage.tsx
git commit -m "feat: redesign services hub as SEO-optimized pillar page

8-section conversion page: hero, pain points, services grid with
outcome bullets, how-it-works process, industry fit cards, stats
strip, FAQ accordion with JSON-LD structured data, and final CTA."
```
