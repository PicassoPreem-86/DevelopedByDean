        ...
        <div className="grid gap-12 lg:grid-cols-[1fr,1.1fr] lg:items-start">
          <div>
            ...
            <p className="mt-5 max-w-xl text-base leading-relaxed text-content-body">
              ...
              technical depth, clear process, and visible implementation detail. This section is built
              around those assets instead of made-up social proof.
            </p>
          ...
          <div className="grid gap-5">
            ...
            <div className="rounded-3xl border border-border-light bg-hero p-6 text-white shadow-card">
              ...
              <p className="mt-3 max-w-lg text-sm leading-relaxed text-white/70">
                ...
                recordings, before-and-after process notes, and implementation breakdowns as real
                projects ship.
              </p>
              <Link
                to="/services"
