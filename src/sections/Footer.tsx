    ...
    <footer className="bg-hero px-6 py-16">
      <div className="mx-auto max-w-container">
        <div className="grid gap-10 sm:grid-cols-2 lg:grid-cols-6">
          ...
          {/* Connect */}
          <div>
            <h4 className="mb-4 text-xs font-semibold uppercase tracking-widest text-white/50">Connect</h4>
            ...
            <p className="mt-2 text-xs text-white/40">Available worldwide &middot; Remote</p>
              ...
              <div className="mt-4 flex gap-3">
                {socialLinks.map((link) => (
                  <a
                    ...
                    className="flex h-9 w-9 items-center justify-center rounded-lg bg-white/5 text-white/40 hover:bg-white/10 hover:text-white transition-all"
